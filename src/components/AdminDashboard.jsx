...
//         {/* Analytics Section */}
//         {analytics && (
//           <div className="mb-12 bg-white rounded-2xl shadow-lg p-6 transform transition-all duration-300 hover:shadow-xl animate-slide-up">
//             <h3 className="text-2xl font-semibold text-gray-800 mb-6">
//               Analytics Overview
//             </h3>
//             <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
//               <div className="bg-blue-100 p-4 rounded-xl flex items-center space-x-4">
...
//                 </div>
//               </div>
//               <div className="bg-red-100 p-4 rounded-xl flex items-center space-x-4">
...
//                 Status:{" "}
//                 <span
//                   className={post.isFlagged ? "text-red-500" : "text-green-500"}
//                 >
...
//                   className="px-4 py-2 rounded-full text-sm font-medium bg-red-500 text-white hover:bg-red-600 transition-all duration-200"
//                 >
//                   Remove
//                 </button>
//                 <button
...
//         className="max-w-7xl mx-auto px-4 pt-32 pb-12"
//       >
//         <motion.h2
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
...
//               className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
//             >
