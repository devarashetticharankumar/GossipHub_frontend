...
//               <FaBell className="h-8 w-8 mr-2 text-red-500" />
//               Notifications
//             </h2>
...
//                 className="flex items-center px-4 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition duration-200"
//               >
...
//                   className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300"
//                 >
//                   <div className="flex items-start">
//                     <FaBell className="h-6 w-6 text-red-500 mr-4 mt-1" />
...
//                       className="absolute top-4 right-4 text-gray-400 dark:text-gray-500 hover:text-red-500 transition duration-200"
//                     >
