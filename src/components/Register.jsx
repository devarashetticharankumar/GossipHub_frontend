...
//       } transition-colors duration-500 pt-20 pb-12 px-4 sm:px-6 lg:px-8 font-poppins flex items-center justify-center`}
//     >
//       <motion.div
//         initial={{ opacity: 0, y: 30 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.6, ease: "easeOut" }}
//         className="max-w-md w-full bg-white dark:bg-gray-900 rounded-xl p-6 sm:p-8 shadow-lg"
//         role="region"
//         aria-label="Register form"
//       >
//         <h2 className="text-3xl font-bold text-indigo-900 dark:text-teal-300 mb-6 text-center">
//           Register
//         </h2>
...
//             whileTap={{ scale: 0.95 }}
//             type="submit"
//             className="w-full bg-indigo-500 dark:bg-teal-500 text-white px-6 py-3 rounded-full hover:bg-indigo-600 dark:hover:bg-teal-600 transition-colors"
//             aria-label="Register"
//           >
//             Register
//           </motion.button>
