...
//             {/* Media */}
//             {post.media && (
//               <motion.div className="relative rounded-t-lg overflow-hidden shadow-xl">
...
//                 className="w-full p-4 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:outline-none resize-none h-24 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
...
//                       className="flex gap-4 p-4 rounded-lg mb-4 border border-gray-200 dark:border-gray-700"
//                     >
//                       <div className="w-10 h-10 rounded-full bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-400 flex items-center justify-center font-bold">
